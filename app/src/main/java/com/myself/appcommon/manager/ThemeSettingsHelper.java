package com.myself.appcommon.manager;
...
public class ThemeSettingsHelper {
     ...
     *
     * @param context
     * @param mThemePackageName private void initTheme(Context context, String
     ...
     * 暂时没有使用到
     *
     * @return public String getCurrentThemePackage() { return
     * mThemePackageName; }
     */
     ...
     *
     * @param themeCallback 实现ThemeCallback接口的Activity
     */
