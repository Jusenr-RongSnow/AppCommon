...
public class IntentUtil {
    ...
    // 4.路径规划
    // Uri uri =
    // Uri.parse("http://maps.google.com/maps?f=dsaddr=startLat%20startLng&daddr=endLat%20endLng&hl=en");
    ...
    public Intent getOpenOtherApplicationIntent(String packageName) {
        // 19 打开另一程序
        Intent intent = new Intent();
        ComponentName cn = new ComponentName(packageName, "com.yellowbook.android2.AndroidSearch");
    ...
    //
    // 23.最基本的share
    // 信息的intent，可以传一段text信息到各个手机上已安装程序：如SMS，Email，sina微波，米聊，facebook，twitter等等
    //
    // Intent it = new Intent(Intent.ACTION_SEND);
    ...
    //// Intent skype =
    // packageManager.getLaunchIntentForPackage("com.skype.raider");
