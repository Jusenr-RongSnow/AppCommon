...
import com.myself.appcommon.anim.RotateXAnimation;
import com.myself.appcommon.anim.RotateYAnimation;
import com.myself.appcommon.anim.RotateZAnimation;
...
public class AnimationUtil {
    ...
    private Animation animationTranslate, animationRotate, animationScale, animationAlpha, animationRotateX,
            animationRotateY, animationRotateZ;
     ...
     * @return
     */
    public Animation animScale(float fromX, float toX, float fromY, float toY, long duration) {
        animationScale = new ScaleAnimation(1f, toX, 1f, toY, Animation.RELATIVE_TO_SELF, 0.5f,
     ...
     * @return
     */
    public Animation animRotate(float fromDegrees, float toDegrees, float pivotXValue, float pivotYValue,
                                long duration) {
        animationRotate = new RotateAnimation(fromDegrees, toDegrees, Animation.RELATIVE_TO_SELF, pivotXValue,
     ...
     * @return
     */
    public Animation animRotate(float fromDegrees, float toDegrees, float pivotXValue, float pivotYValue, long duration,
                                AnimationListener animationListener) {
        animationRotate = new RotateAnimation(fromDegrees, toDegrees, Animation.RELATIVE_TO_SELF, pivotXValue,
                Animation.RELATIVE_TO_SELF, pivotYValue);
        animationRotate.setDuration(duration);
     ...
     * @return
     */
    public Animation animTranslate(float fromX, float toX, float fromY, float toY, long duration) {
     ...
     * @return
     */
    public Animation animAlpha(float fromAlpha, float toAlpha, long duration, AnimationListener animationListener) {
        animationAlpha = new AlphaAnimation(fromAlpha, toAlpha);
        animationAlpha.setDuration(duration);
        animationAlpha.setFillAfter(true);
    ...
    public Animation animRotateX(float fromDegree, float toDegree, long duration, int centerX, int centerY,
                                 AnimationListener animationListener) {
        animationRotateX = new RotateXAnimation(fromDegree, toDegree, centerX, centerY);
    ...
    public Animation animRotateY(float fromDegree, float toDegree, long duration, int centerX, int centerY,
                                 AnimationListener animationListener) {
        animationRotateY = new RotateYAnimation(fromDegree, toDegree, centerX, centerY);
    ...
    public Animation animRotateZ(float fromDegree, float toDegree, long duration, int centerX, int centerY,
                                 AnimationListener animationListener) {
        animationRotateZ = new RotateZAnimation(fromDegree, toDegree, centerX, centerY);
     ...
     * @return
     */
    public static AnticipateOvershootInterpolator getAnticipateOvershootInterpolator(float tension) {
