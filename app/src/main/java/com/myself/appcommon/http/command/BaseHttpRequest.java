...
import com.myself.appcommon.util.StringUtil;
...
public abstract class BaseHttpRequest {
     ...
     */
    abstract public HttpEngine.HttpCode prepareRequest();
     ...
     * @return
     */
    protected HttpEngine.HttpCode checkUrlParams() {
        if (this.url == null || this.url.equals("")) {
            return HttpEngine.HttpCode.ERROR_NET_ACCESS;
        }

        return HttpEngine.HttpCode.STATUS_OK;
    }
