...
import com.dsw.calendar.component.SquareMonthView;
...
public class SquareCalendarView extends LinearLayout implements View.OnClickListener {
    ...
    private SquareMonthView squareMonthView;
    private TextView textViewYear, textViewMonth;

    public SquareCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        squareMonthView.setMonthLisener(new MonthView.IMonthLisener() {
            ...
            public void setTextMonth() {
                textViewYear.setText(squareMonthView.getSelYear() + "年");
                textViewMonth.setText((squareMonthView.getSelMonth() + 1) + "月");
            }
        });
    }
    ...
    public void setDateClick(MonthView.IDateClick dateClick) {
        squareMonthView.setDateClick(dateClick);
    }
    ...
    public void setCalendarInfos(List<CalendarInfo> calendarInfos) {
        squareMonthView.setCalendarInfos(calendarInfos);
        textViewYear.setText(squareMonthView.getSelYear() + "年");
        textViewMonth.setText((squareMonthView.getSelMonth() + 1) + "月");
    }

    public void setDayTheme(IDayTheme theme) {
        squareMonthView.setTheme(theme);
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.left) {
            squareMonthView.onLeftClick();
        } else {
            squareMonthView.onRightClick();
        }
    }
}
