...
public class PersistentCookieStore implements CookieStore {
    ...
    protected void add(HttpUrl uri, Cookie cookie) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + name, encodeCookie(new com.okhttp.cookie.store.SerializableHttpCookie(cookie)));
        prefsWriter.apply();
    }
    ...
    protected String encodeCookie(com.okhttp.cookie.store.SerializableHttpCookie cookie) {
        if (cookie == null)
            return null;
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((com.okhttp.cookie.store.SerializableHttpCookie) objectInputStream.readObject()).getCookie();
        } catch (IOException e) {
